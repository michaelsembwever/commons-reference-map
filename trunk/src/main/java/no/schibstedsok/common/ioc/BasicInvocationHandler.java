 ...
 */
public final class BasicInvocationHandler implements InvocationHandler{
    ...
    public BasicInvocationHandler(final BaseContext[] cxts) {
        contexts = Collections.unmodifiableList( Arrays.asList(cxts) );
        
    }

    public Object invoke(final Object object, 
            final Method method, final Object[] objArr) throws Throwable {
